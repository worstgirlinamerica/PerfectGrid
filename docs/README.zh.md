...
Perfect Grid 是一款免费的开源桌面应用程序，用于根据本地视频文件创建视频接触片和预览缩略图。只需导入视频、选择布局，即可导出高质量的 PNG 接触片。

专为剪辑师、收藏家、档案管理员以及任何希望快速直观地概览视频内容的人士设计。
...
<p align="center">
  ...
  <a href="https://github.com/worstgirlinamerica/PerfectGrid/releases/latest/download/PerfectGrid-v0.1.2-Linux-x86_64.AppImage">
    <img src="https://custom-icon-badges.demolab.com/badge/Download-Linux-E95420?logo=linux&logoColor=white" alt="Linux 版下载">
  </a>
</p>
...
> 如果您遇到任何错误、功能异常或有任何疑问，请创建一个 [问题报告](https://github.com/worstgirlinamerica/PerfectGrid/issues/new) 进行反馈。

## 本地化

该应用的用户界面支持 8 种语言。图表文件名的渲染采用独立系统——它将文件名以像素形式绘制在导出的 PNG 文件上，这需要脚本特有的字体处理机制。
...
> 目前不支持 Linux 系统中非 ASCII 文件名的渲染——非拉丁字符集的文件名将显示为方块。此问题将在下个版本中修复！
...
2. 双击解压，然后将 Perfect Grid 拖放到“应用程序”文件夹中。
...
若从源代码运行并需全面支持阿拉伯语/从右到左（RTL）文件名：
...
请务必提供以下关键信息：您的操作系统、视频格式，以及问题发生在“预览”、“优化”、“导出”还是“批量处理”阶段。
